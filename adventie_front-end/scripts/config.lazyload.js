    ...
    .config(['$ocLazyLoadProvider', function($ocLazyLoadProvider) {
        $ocLazyLoadProvider.config({
            ...
            modules: [{
                    ...
                    files: [
                        'assets/plugins/moment/moment.min.js',
                        'assets/plugins/angular-bootstrap-datetimepicker/src/css/datetimepicker.css',
                        'assets/plugins/angular-bootstrap-datetimepicker/src/js/datetimepicker.js',
                        'assets/plugins/angular-bootstrap-datetimepicker/src/js/datetimepicker.templates.js'
                    ],
                    serie: true
                }, {
                    name: 'timepicker',
                    ...
                    name: 'ng-map',
                    files: [
                        'js!https://maps.googleapis.com/maps/api/js?key=AIzaSyCKh54DsYqthrJOYacaWpWxxr13R7m3TFk&libraries=placeses,visualization,drawing,geometry,places',
                        'assets/plugins/ngmap/build/scripts/ng-map.min.js'
                    ]
                },  {
                    name: 'interact',
                    files: [
