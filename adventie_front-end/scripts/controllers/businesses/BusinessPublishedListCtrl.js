...
// Chart controller
    .controller('BusinessPublishedListCtrl', ['$scope', '$state', '$location', '$rootScope', 'ArticleService', 'UserService', 'BusinessService', 'LanguageService',
        function ($scope, $state, $location, $rootScope, ArticleService, UserService, BusinessService, LanguageService) {
